...
#define cophh_exists_pvn(cophh, keypv, keylen, hash, flags) \
    cBOOL(Perl_refcounted_he_exists_pvn(aTHX_ cophh, keypv, keylen, hash, flags | COPHH_EXISTS))
...
#define cophh_exists_pvs(cophh, key, flags) \
    cBOOL(Perl_refcounted_he_exists_pvn(aTHX_ cophh, STR_WITH_LEN(key), 0, flags | COPHH_EXISTS))
...
#define cophh_exists_pv(cophh, key, hash, flags) \
    cBOOL(Perl_refcounted_he_exists_pv(aTHX_ cophh, key, hash, flags | COPHH_EXISTS))
...
#define cophh_exists_sv(cophh, key, hash, flags) \
    cBOOL(Perl_refcounted_he_exists_sv(aTHX_ cophh, key, hash, flags | COPHH_EXISTS))
