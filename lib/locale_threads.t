...
elsif (grep { $_ eq 'LC_CTYPE' } @valid_categories) {
...
#    print STDERR __LINE__, ": all: ", Dumper \@non_utf8_locales;
    ...
    #print STDERR __LINE__, ": utf8: ", Dumper \@utf8_locales;
    foreach my $utf8 (@utf8_locales) {
        @non_utf8_locales = grep { $_ ne $utf8 } @non_utf8_locales;
    }
    #print STDERR __LINE__, ": non-utf8: ", Dumper \@non_utf8_locales;
    ...
    push $valid_locales{$master_category}->@*, (@prioritized,
                                         @non_utf8_locales,
                                         @utf8_locales);
}
...
sub add_trials($$;$)
{
    ...
    foreach my $locale ($valid_locales{$master_category}->@*) {
